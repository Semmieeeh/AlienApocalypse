...
public class ShootEffectMultiplayer : MonoBehaviourPunCallbacks
{
    [SerializeField]
...
[CustomEditor(typeof(ShootEffectMultiplayer))]
[CanEditMultipleObjects]
public class ShootEffectMultiplayerEditor : Editor
{
    ShootEffectMultiplayer effect;

    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
        effect = target as ShootEffectMultiplayer;
